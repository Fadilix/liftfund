...
function createDefaultAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var defaultEmail, defaultPassword, existingAdmin, hashedPassword, admin, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, 5, 7]);
                    defaultEmail = 'admin@caleb.com';
                ...
                case 3:
                    ...
                    console.log("\uD83D\uDCE7 Email: ".concat(defaultEmail));
                    console.log("\uD83D\uDD10 Mot de passe: ".concat(defaultPassword));
                    console.log('⚠️  Pensez à changer ce mot de passe après la première connexion!');
                    return [3 /*break*/, 7];
                case 4:
                    error_1 = _a.sent();
                    console.error('❌ Erreur lors de la création de l\'admin:', error_1);
                    return [3 /*break*/, 7];
